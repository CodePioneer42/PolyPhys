...
test("chromosome idea-to-model skill explores project context and records final design docs", async () => {
  const skillDoc = await readFile(skillPath, "utf8");

  assert.match(skillDoc, /Explore project context/i);
  assert.match(skillDoc, /check files, docs, recent commits/i);
